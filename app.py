...
async def upload_and_query(image: UploadFile = File(...), query: str = Form(...)):
    try:
        ...
        template_instruction = (
            ...
            "Only respond to healthcare-related images or queries.\n"
            "If the input is not related to health or medicine, respond with:\n"
            "\"Ask a health-related query.\"\n\n"
            "When answering, strictly follow the format below:\n\n"
            "**Diagnosis:**\n"
            "<Your medical assessment here>\n\n"
            "**Possible Causes:**\n"
            "- <Cause 1>\n"
            "- <Cause 2>\n\n"
            "**Recommended Tests:**\n"
            ...
            "- <Treatment 1>\n"
            "- <Treatment 2>\n\n"
            "*Do not include any explanations or comments outside this format.*"
        )
